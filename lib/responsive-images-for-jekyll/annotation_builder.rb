  ...
  def create_svg(img_desc, svg_file_path, img_dim)
    ...
    if svg_w == 1800
      svg.build do
        ...
        svg.text "Cevi Züri 11", text_anchor: :middle, x: svg_w - 125 - claim_width / 2, y: svg_h - 100 - claim_v_border, font_weight: 'bold', font_family: 'Ubuntu-Regular', font_size: claim_font_size, fill: :"#585858", style: { stroke: '#585858' }
        svg.text img_desc, text_anchor: :middle, x: svg_w - 100 - claim2_width / 2, y: svg_h - 100 - claim_v_border - claim_height - claim_space, font_weight: 'bold', font_family: 'Ubuntu-Regular', font_size: claim_font_size, fill: :"#585858", style: { stroke: '#585858' }
      end
